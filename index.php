...
<html lang="en">
  <head>
    ...
    <title>Travelours company</title>
  ...
  <body>
      ...
      <div class="container">
        <nav class="navigation">
          ...
          <ul>
            ...
            <li><a href="scripts/tours.php">Tours</a></li>
    ...
    <div class="section-hero">
      <div class="container hero-cont">
        <div class="hero">
          <h1 class="main-heading">Welcome to Travelours</h1>
          <p class="hero-text">
            Expirience the best tours with us from various packages,places and
            wonderful expirience with us.
          </p>
    ...
    <main>
      ...
      <section class="section-popular">
        <div class="container">
          <div class="sec-polular">
            <h2 class="secondary-heading">The top rated tours</h2>
            <div class="popular-grid popular-1">
              ...
              <div class="item-det">
                <ul>
                  <li>
                    <span class="popular-heading">The wildlife ultimate</span>
                  </li>
      ...
      <section class="section-chooseus">
        <div class="container">
          <h2 class="secondary-heading choose-us-head">Why choose us?</h2>
          <div class="choose-us">
