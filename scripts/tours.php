...
<html lang="en">
  ...
  <body>
   <?php include '../templates/header.php';?>
    <div class="hero-t tours-bg">
      <div class="hero-det">
        <h1 class="hero-main-heading">View some intresting tours</h1>
      </div>
    </div>
    ...
    <main>
      <section class="section-tours">
        <div class="container">
          <div class="maintours">
            <h2 class="tours-subheading">View all tours</h2>
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                 ...
                 echo    "<p class='tour-name'>" .$row['tourname'] ."</p>";
                 echo  "</div>";
